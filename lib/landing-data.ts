...
type Notice = { date: string; month: string; type: "Event" | "Notice"; title: string; summary: string; href?: string; external?: boolean; actionLabel?: string };
