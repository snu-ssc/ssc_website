...
type Program = { category: string; tag: string; index: string; title: string; description: string };
type Gallery = { label: string; title: string; image: string; alt: string; detail: string };
...
export const landing: Record<Locale, LandingCopy> = {
  ko: {
    ...
    programs: [{ category: "Study", tag: "FUNDAMENTALS", index: "01", title: "Semiconductor Study", description: "소자·회로·공정을 함께 읽고 토론하는 정규 스터디" }, { category: "Project", tag: "DESIGN LAB", index: "02", title: "Chip Design Project", description: "아이디어에서 RTL과 검증까지 직접 만드는 설계 프로젝트" }, { category: "Industry", tag: "FIELD NOTE", index: "03", title: "Technical Workshop", description: "현업 전문가와 함께 최신 기술을 깊이 있게 탐색하는 워크숍" }, { category: "Industry", tag: "NETWORK", index: "04", title: "Industry Visit", description: "연구와 산업의 접점에서 다음 질문을 발견하는 현장 탐방" }],
    gallerySection: { title: "배움의 순간이\n우리의 다음 장면이 됩니다.", description: "작은 질문에서 시작해 서로의 성장을 기록하는 SSC의 현장입니다." },
    gallery: [{ label: "WORKSHOP", title: "Jeju Technical Workshop", image: workshop, alt: "노트북으로 기술 워크숍을 진행하는 SSC 구성원", detail: "기술에 몰입하고 서로의 아이디어를 나눈 SSC의 첫 번째 제주 테크니컬 워크숍입니다." }, { label: "STUDY", title: "SSC Study Session", image: workshop, alt: "SSC 스터디 세션", detail: "같은 질문을 다른 시선으로 바라보며 더 선명한 이해를 만드는 시간입니다." }, { label: "PROJECT", title: "From Idea to Silicon", image: workshop, alt: "SSC 프로젝트 세션", detail: "구현과 검증을 반복하며 아이디어를 실제 설계로 이어갑니다." }],
  ...
  en: {
    ...
    programs: [{ category: "Study", tag: "FUNDAMENTALS", index: "01", title: "Semiconductor Study", description: "A recurring study group for devices, circuits, and processes." }, { category: "Project", tag: "DESIGN LAB", index: "02", title: "Chip Design Project", description: "Hands-on projects from initial ideas through RTL and verification." }, { category: "Industry", tag: "FIELD NOTE", index: "03", title: "Technical Workshop", description: "Deep dives into emerging technology with industry practitioners." }, { category: "Industry", tag: "NETWORK", index: "04", title: "Industry Visit", description: "Field visits that reveal the next questions at the edge of research and industry." }],
    ...
    gallery: [{ label: "WORKSHOP", title: "Jeju Technical Workshop", image: workshop, alt: "SSC members working on laptops during a technical workshop", detail: "SSC's first technical workshop in Jeju: focused sessions, bright ideas, and conversations that continued beyond the room." }, { label: "STUDY", title: "SSC Study Session", image: workshop, alt: "SSC study session", detail: "A space to see the same question from new perspectives and make understanding more precise." }, { label: "PROJECT", title: "From Idea to Silicon", image: workshop, alt: "SSC project session", detail: "Turning a question into a real design through repeated implementation and validation." }],
