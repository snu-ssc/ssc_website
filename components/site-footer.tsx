...
export function SiteFooter({ locale, includeEmail = true }: { locale: Locale; includeEmail?: boolean }) {
  ...
  return <footer className="site-footer">
    <div className="container site-footer__inner">
      <div><Image src="/images/brand/logo-letter-transparent.png" alt="SNU SemiCon" width={188} height={58} /><p className="site-footer__school"><Image src="/images/brand/snu-emblem.png" alt="" width={30} height={30} />{c.footer.school}</p></div>
